...
public class node03 {
    ...
    // 当前上线的节点名称
    private static final String NAMENODE_HOST = "node-03";
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (activeNM.size() == 1) {
            ...
            System.out.println("----》" + activeNM.get(0) + " 节点是active角色, 当前启动节点： " + NAMENODE_HOST + "成为standby角色");
            ...
            zookeeper.create(LOCK_ZNODE, NAMENODE_HOST.getBytes(),
                    ZooDefs.Ids.OPEN_ACL_UNSAFE, CreateMode.EPHEMERAL);
            System.out.println("发现没有active节点，去争抢成为" + NAMENODE_HOST + " 节点成为master节点");
        }
